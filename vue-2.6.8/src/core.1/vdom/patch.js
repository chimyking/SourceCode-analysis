...
export function createPatchFunction(backend) {
  ...
  return function patch(oldVnode, vnode, hydrating, removeOnly) {
    ...
    // }˚
    /**
     * 如果新的vnode不存在， oldVnode存在，则表示删除了该节点
     * 执行Destroy 并且返回
     */
    if (isUndef(vnode)) {
    ...
    if (isUndef(oldVnode)) {
       ...
       * 
       */
      const isRealElement = isDef(oldVnode.nodeType) // 真实节点会有nodeType属性
